...
export type ReceiptKey =
  ...
  | "notes"
  | "paymentTerms"
  // WhatsApp invoice payment-status line
  | "balanceDue"
  | "paidInFull"
...
const DICT: Record<ReceiptKey, LangMap> = {
  ...
  balanceDue: { en: "Balance Due", hi: "शेष देय", mr: "शिल्लक देय", gu: "બાકી ચૂકવવાનું", ta: "நிலுவை" },
  paidInFull: {
    en: "Paid in full. Thank you!",
    hi: "पूर्ण भुगतान प्राप्त। धन्यवाद!",
    mr: "पूर्ण भरणा झाला. धन्यवाद!",
    gu: "સંપૂર્ણ ચૂકવણી થઈ. આભાર!",
    ta: "முழுமையாக செலுத்தப்பட்டது. நன்றி!",
  },
}
